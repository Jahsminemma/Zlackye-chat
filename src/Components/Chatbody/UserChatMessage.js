...
const UserChatMessage = ({ Messages, audio, pdf, progress }) => {
    ...
    return (
        <div style={{ marginTop: "110px", textAlign: "left" }} className="chatMessage">
                        ...
                        return (
                            <div style={{ marginRight: "70px" }} key={createdAt} className="message">
                                <div className="message__content">
                                    <div className="message__item">
                                        {pdfUrl && pdf ? <div className="pdf-content">
                                            <a href={pdfUrl}>
                                            <img src="data:image/png;base64," alt="reviewed image" />
                                            <p>{pdf.name}</p>
                                        </a>
                                        ...
                                        {audioUrl && audio ? <div className="audio-content">
                                            <audio controls controlsList="nodownload">
                                                <source src={audioUrl}/>
                                                Your browser does not support the audio element.
                                                </audio>
